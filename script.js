...
/* let evento = {
    ...
    name: "Books",
    date: 15 / 10 / 2023,
    description: "La razón de ser de ITIAHaiti es reventar la claridad de una corriente literaria. La idea se amplía en las redes sociales para dar a luz una escuela literaria. Socio Educational NGO. Cultural Organization. Courses: Youth organization, Self-reliance, Literary meeting.",
    category: "Ocio",
    place: "Menphys",
    assitance: "none",
    price: 1000,
